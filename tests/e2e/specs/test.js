...
module.exports = {
  ...
  "info e2e tests": browser => {
    browser
      ...
      .assert.containsText(
        ".info > .header",
        "Hello! I'm the SELFIE CHATBOT. How can I help you?"
      )
  ...
  "conversation e2e tests": browser => {
    browser
      ...
      .assert.elementPresent(
        ".chat .conversation .chatbot .col > i.fas.fa-robot.fa-2x"
      )
      .assert.containsText(
        ".chat .conversation .chatbot .col-8 > span.text",
        "Hello! How can I help you?"
      )
      .assert.elementPresent(".chat .question")
      .assert.elementPresent(
        '.chat .question form .input-group input[type="text"]'
      )
      .assert.elementPresent(
        ".chat .question form .input-group .input-group-append button.btn.btn-outline-secondary > i.fas.fa-paper-plane.fa-lg"
      )
      .assert.elementPresent(
        ".chat .question form .input-group .input-group-append button.btn.btn-outline-secondary > i.fas.fa-eraser.fa-lg"
      )
      .end();
  },
  ...
  "question input e2e tests": browser => {
    browser
      ...
      .assert.containsText(
        ".conversation .user.conversation-item",
        "What is SELFIE?"
      )
